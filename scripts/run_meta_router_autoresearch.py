    ...
    for kind, scope_name, thresholds in specs:
        ...
        if scope_name == "all":
            ...
            scopes = {
                ...
                "base_margin_lte_015": base_margin_values <= 0.15,
                "base_margin_lte_018": base_margin_values <= 0.18,
                "base_margin_lte_020": base_margin_values <= 0.20,
                "base_margin_lte_022": base_margin_values <= 0.22,
                "base_margin_lte_025": base_margin_values <= 0.25,
